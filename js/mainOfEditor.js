...
requirejs.config({
    ...
    paths: {
        ...
        'mCustomScrollbar':'lib/malihu-scrollbar/jquery.mCustomScrollbar'
    },
    shim: {
        'bootstrap':['jquery'],
        'angular': ['jquery'],
        ...
        'test': ['ocLazyLoad','ngLayout','smart-table','bootstrap','select2', 'application','layers','applicationfuns','keyPressFunctions','bootspopover','bootstrapDatepicker','bootstrapDatepickerCN','timepicki','sweet-alert','poi-msg','mCustomScrollbar']
    }
});
