...
fastmap.dataApi.sideWalk = fastmap.dataApi.GeoDataModel.extend({
 ...
 */
fastmap.dataApi.sidewalk = function (data, options) {
    return new fastmap.dataApi.sideWalk(data, options);
}
