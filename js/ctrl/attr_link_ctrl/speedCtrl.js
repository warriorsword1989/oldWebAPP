...
realtimeTrafficApp.controller("speedController",function($scope,$timeout,$ocLazyLoad) {
    ...
    $scope.showOridinarySpeedInfo= function (item) {
        ...
        var oridinarySpeedObj = {
            ...
            "propertyCtrl": 'ctrl/attr_link_ctrl/speedOfOrdinaryCtrl',
            "propertyHtml": 'js/tpl/attr_link_tpl/speedOfOrdinaryTpl.html'
        }
    ...
    $scope.showspeedlimitInfo= function (cItem) {
        ...
        var speedlimitInfoObj = {
            "loadType":"subAttrTplContainer",
            "propertyCtrl": 'ctrl/attr_link_ctrl/speedOfConditionCtrl',
            "propertyHtml": 'js/tpl/attr_link_tpl/speedOfConditionTpl.html'
        }
