...
myApp.controller('linkObjectController', ['$scope', '$ocLazyLoad',function ($scope, $ocLazyLoad) {
    ...
    $scope.changeModule = function (url,ind) {
        ...
        if (url === "basicModule") {
            ...
            $ocLazyLoad.load('ctrl/attr_link_ctrl/pedestrianNaviCtrl').then(function () {
            ...
            $ocLazyLoad.load('ctrl/attr_link_ctrl/namesCtrl').then(function () {
                $scope.currentURL = "js/tpl/attr_link_tpl/namesTpl.html";
            });
        }else if (url == "speedModule") {//限速
            $ocLazyLoad.load('ctrl/attr_link_ctrl/speedCtrl').then(function () {
                $scope.currentURL = "js/tpl/attr_link_tpl/speedTpl.html";
            });
        }
    }
    ...
    $scope.changeLink=function(ind,linkId){
        ...
        Application.functions.getRdObjectById(linkId, "RDLINK", function (data) {
            ...
            var linkObj = {
                ...
                "propertyCtrl":"ctrl/attr_link_ctrl/rdLinkCtrl",
                "propertyHtml":"js/tpl/attr_link_tpl/rdLinkTpl.html"
            };
