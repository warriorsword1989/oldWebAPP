...
basicApp.controller("basicController",function($scope,$ocLazyLoad) {
    ...
    $scope.addFormOfWay = function() {
        var addFormOfWayObj={
            "loadType":"subAttrTplContainer",
            "propertyCtrl":'ctrl/attr_link_ctrl/basicOfFormWayCtrl',
            "propertyHtml":'js/tpl/attr_link_tpl/basicOfFormWayTpl.html'
        }
    ...
    $scope.showZoneWin=function(item){
        ...
        var showZoneWinObj={
            "loadType":"subAttrTplContainer",
            "propertyCtrl":'ctrl/attr_link_ctrl/infoOfZoneCtrl',
            "propertyHtml":'js/tpl/attr_link_tpl/infoOfZoneTpl.html'
        }
    ...
    $scope.showZone=function(item){
        var showZoneObj={
            "loadType":"subAttrTplContainer",
            "propertyCtrl":'ctrl/attr_link_ctrl/basicOfZoneCtrl',
            "propertyHtml":'js/tpl/attr_link_tpl/basicOfZoneTpl.html'
        }
    ...
    $scope.showOther=function(){
        var showOtherObj={
            "loadType":"subAttrTplContainer",
            "propertyCtrl":'ctrl/attr_link_ctrl/basicOfOtherCtrl',
            "propertyHtml":'js/tpl/attr_link_tpl/basicOfOtherTpl.html'
        }
