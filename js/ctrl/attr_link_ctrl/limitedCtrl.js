...
limitedApp.controller("limitedController", function ($scope,$timeout,$ocLazyLoad) {
    ...
    $scope.showOrdinaryInfo=function(item) {
        ...
        var showOrdinaryObj={
            ...
            "propertyCtrl":'ctrl/attr_link_ctrl/limitOfOrdinaryCtrl',
            "propertyHtml":'js/tpl/attr_link_tpl/limitOfOrdinaryTpl.html'
        }
    ...
    $scope.showTrcukInfo=function(item) {
        ...
        var showTrcukObj={
            "loadType":"subAttrTplContainer",
            "propertyCtrl":'ctrl/attr_link_ctrl/limitOfTruckCtrl',
            "propertyHtml":'js/tpl/attr_link_tpl/limitOfTruckTpl.html'
        }
