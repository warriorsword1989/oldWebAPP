...
laneConnexityApp.controller("addLaneConnexityController", ["$scope", '$ocLazyLoad', function ($scope, $ocLazyLoad) {
    ...
    var changedDirectObj = {
        ...
        "propertyCtrl":'ctrl/toolBar_cru_ctrl/addConnexityCtrl/directOfConnexityCtrl',
        "propertyHtml":'js/tpl/toolBar_cru_tpl/addConnexityTepl/directOfConnexityTpl.html'
    };
