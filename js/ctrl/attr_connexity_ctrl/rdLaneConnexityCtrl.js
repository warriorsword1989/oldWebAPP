...
otherApp.controller("rdLaneConnexityController", function ($scope, $ocLazyLoad, $document) {
    ...
    $scope.initializeData = function () {
        ...
        for (var i = 0, len = (objCtrl.data.topos).length; i < len; i++) {
            linksObj["outLink" + i] = objCtrl.data.topos[i].outLinkPid.toString();
        }
        ...
        var highLightLane = new fastmap.uikit.HighLightRender(hLayer, {
            map: map,
            highLightFeature: "lane",
            laneId: $scope.lanesData.pid.toString(),
            initFlag: true
        });
    ...
    $scope.changeDirect = function (item, event, index) {
        if (event.button === 2) {
            ...
            var changedDirectObj = {
                ...
                "propertyCtrl":'ctrl/attr_connexity_ctrl/changeDirectCtrl',
                "propertyHtml":'js/tpl/attr_connexity_tpl/changeDirectTpl.html'
            };
    ...
    $scope.showLanesInfo = function (item, index, event) {
        ...
        var showInfoObj = {
            "loadType":"subAttrTplContainer",
            "propertyCtrl":'ctrl/attr_connexity_ctrl/showInfoCtrl',
            "propertyHtml":'js/tpl/attr_connexity_tpl/showInfoTpl.html'
        };
    ...
    $scope.addLane = function () {
       ...
       if($scope.lanesData["selectNum"]!==undefined) {
        ...
        var addDirectObj = {
            "loadType":"subAttrTplContainer",
            "propertyCtrl":'ctrl/attr_connexity_ctrl/addDirectCtrl',
            "propertyHtml":'js/tpl/attr_connexity_tpl/addDirectTpl.html'
        };
