...
App.layersConfig = [{
    ...
    layers: [{
        ...
        options: {
            ...
            restrictZoom: 10,
            visible: false,
            requestType: 'RDRESTRICTION,RDSPEEDLIMIT,RDBRANCH,RDCROSS,RDLANECONNEXITY,RDLINKINTRTIC,RDGSC,RDWARNINGINFO,RDTRAFFICSIGNAL,RDELECTRONICEYE,RDSLOPE,RDGATE,RDDIRECTROUTE,RDSPEEDBUMP,RDSE,RDINTER',
            showNodeLevel: 17
        }
    }, {
        url: '/render/obj/getByTileWithGap?',
