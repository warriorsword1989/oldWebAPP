 ...
 */
// 条件线限速个数
fastmap.uikit.canvasTMFeature.TMSpeedlimitConditionCount = fastmap.uikit.canvasTMFeature.TMFeature.extend({
  geometry: {},
  properties: {},
  setAttribute: function (data) {
    var RD_LINK_Colors = ['#008500', '#FA04C9', '#FF0000', '#A500EC', '#0000FF'];
