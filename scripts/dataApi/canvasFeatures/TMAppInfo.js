 ...
 */
// 供用信息
fastmap.uikit.canvasTMFeature.TMAppInfo = fastmap.uikit.canvasTMFeature.TMFeature.extend({
  geometry: {},
  properties: {},
  setAttribute: function (data) {
    var RD_LINK_Colors = ['#909090', '#000000', '#FF0000', '#FF8000', '#FF00FF', '#0000FF', '#00FF00'];
