        ...
        create: function(item) {
            ...
            switch (item.t) {
                ...
                case 1203://道路方向
                    ...
                    break;
                case 1204://可逆车道
                    ret = new fastmap.uikit.canvasTips.TipsReversibleLane(item);
                    break;
                case 1205://SA
                ...
                case 1302://普通交限
                    ...
                    break;
                case 1303://卡车交限
                    ret = new fastmap.uikit.canvasTips.TipsTruckRestrictionTemp(item);
                ...
                case 1703://分叉路口提示
                    ...
                    break;
                case 1704://交叉路口
                    ret = new fastmap.uikit.canvasTips.TipsRoadCross(item);
                    break;
                case 1705://立交桥名称
                    ret = new fastmap.uikit.canvasTips.TipsOverpassName(item);
                    break;
                case 1706://GPS打点
                    ret = new fastmap.uikit.canvasTips.TipsGPSDot(item);
                    break;
                case 1707://里程桩
                    ret = new fastmap.uikit.canvasTips.TipsMileagePeg(item);
                    break;
                case 1801://立交
