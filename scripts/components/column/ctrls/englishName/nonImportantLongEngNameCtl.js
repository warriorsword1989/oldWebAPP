 ...
 */
angular.module('app').controller('NonImportantLongEngNameCtl', ['$scope', '$ocLazyLoad', 'NgTableParams', 'ngTableEventsChannel', 'uibButtonConfig', '$sce', '$document', 'appPath', '$interval', '$timeout', 'dsMeta', '$compile', '$attrs', 'dsColumn',
    function ($scope, $ocLazyLoad, NgTableParams, ngTableEventsChannel, uibBtnCfg, $sce, $document, appPath, $interval, $timeout, dsMeta, $compile, $attrs, dsColumn) {
        ...
        $scope.cols = [
            ...
            { field: 'name12Eng', title: '官方原始英文名称', getValue: get12EngNames, show: true },
...
//                }
                getData: function ($defer, params) {
                    var param = {
                        ...
                        secondWorkItem: 'nonImportantLongEngName',
                        status: 1
                    };
...
//            { field: "num_index", title: "序号",show: true,width:'20px'},
            ...
            { field: 'name12Eng', title: '官方原始英文名称', getValue: getName, html: true, show: true, width: '150px' },
