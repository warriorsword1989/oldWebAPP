/**
 * Created by wuz on 2016/11/17.
 */
angular.module('app').controller('restrictionTruckController', ['$rootScope', '$scope', '$timeout', '$ocLazyLoad', 'dsFcc', 'dsEdit', '$q', function ($rootScope, $scope, $timeout, $ocLazyLoad, dsFcc, dsEdit, $q) {
