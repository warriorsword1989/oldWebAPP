 ...
 */
angular.module('app').controller('RoadNameCtl', ['$scope', '$ocLazyLoad', 'NgTableParams', 'ngTableEventsChannel', 'uibButtonConfig', '$sce', 'dsEdit', '$document', 'appPath', '$interval', '$timeout', 'dsMeta', '$compile', '$attrs',
    function ($scope, $ocLazyLoad, NgTableParams, ngTableEventsChannel, uibBtnCfg, $sce, dsEdit, $document, appPath, $interval, $timeout, dsMeta, $compile, $attrs) {
        ...
        $scope.cols = [
            { field: 'selector', headerTemplateURL: 'headerCheckboxId', show: true },
                ...
                getData: function ($defer, params) {
                    var param = {
                        ...
                        params: {
                            ...
                            nameGroupid: params.filter().nameGroup,
                            admin: params.filter().admin,
                            sql: params.filter().sql
                        }
                    };
