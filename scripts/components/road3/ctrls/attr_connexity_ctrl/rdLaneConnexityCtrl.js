...
otherApp.controller("rdLaneConnexityController", function ($scope, $ocLazyLoad, $document) {
    ...
    $scope.changeDirect = function (item, event, index) {
        if (event.button === 2) {
            ...
            var changedDirectObj = {
                ...
                "propertyCtrl":'scripts/components/road/ctrls/attr_connexity_components/road/ctrls/changeDirectCtrl',
    ...
    $scope.showLanesInfo = function (item, index, event) {
        ...
        var showInfoObj = {
            "loadType":"subAttrTplContainer",
            "propertyCtrl":'scripts/components/road/ctrls/attr_connexity_ctrl/showInfoCtrl',
    ...
    $scope.addLane = function () {
       ...
       if($scope.lanesData["selectNum"]!==undefined) {
        ...
        var addDirectObj = {
            "loadType":"subAttrTplContainer",
            "propertyCtrl":'scripts/components/road/ctrls/attr_connexity_ctrl/addDirectCtrl',
    ...
    $scope.changeTransit=function(item,index) {
        if(item!=="test") {
            ...
            var changedTransitObj = {
                "loadType":"subAttrTplContainer",
                "propertyCtrl":'script/components/road/ctrls/attr_connexity_ctrl/changeDirectCtrl',
                "propertyHtml":'../../../scripts/components/road/tpls/attr_connexity_tpl/changeDirectTpl.html'
            };
