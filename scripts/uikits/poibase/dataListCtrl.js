angular.module('app', ['oc.lazyLoad', 'ui.bootstrap', 'ngTable', 'dataService', 'ngSanitize', 'ngCookies']).controller('DataListCtl', ['$scope', '$ocLazyLoad','dsPoi', 'dsMeta', '$q', function($scope, $ocll, poi, meta, $q ) {
	var promises = [];
