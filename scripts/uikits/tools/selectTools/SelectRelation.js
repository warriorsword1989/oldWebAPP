    ...
    drawGeomCanvasHighlight: function (tilePoint, event) {
        ...
        if (this.overlays.length == 1) {
            ...
            for (var item in this.overlays) {
                html += '<li><a href="#" id="' + this.overlays[item].data.properties.featType + this.overlays[item].id+'">' +App.Temp.relationNameObj[this.overlays[item].data.properties.featType]  +"&nbsp"+ this.overlays[item].id+ '</a></li>';
            }
            html += '</ul>';
            this.popup
